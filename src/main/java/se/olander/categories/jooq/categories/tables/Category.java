...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = -743235786;

    /**
     * The reference instance of <code>categories.category</code>
     */
    ...
    /**
     * Create a <code>categories.category</code> table reference
     */
    public Category() {
        this("category", null);
    }
    ...
    /**
     * Create an aliased <code>categories.category</code> table reference
     */
